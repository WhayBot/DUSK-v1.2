...
Central Configuration File (libgpiod Version)

All GPIO pin assignments, I2C channel mappings, and system constants.
Differences from RPi.GPIO version:
  - Added GPIO_CHIP path for gpiod
  - Same pin numbering (BCM maps directly to gpiod offsets)
"""

# ==============================================================================
# LIBGPIOD CONFIGURATION
# ==============================================================================
# GPIO chip device path
# Raspberry Pi Zero 2W uses gpiochip0
