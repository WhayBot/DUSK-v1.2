#!/bin/bash
# ============================================================
# DUSK - Setup Script for Raspberry Pi Zero 2W (libgpiod Version)
...
echo "============================================================"
echo "  DUSK - Setup Script (libgpiod Version)"
...
# Enable hardware PWM for ESC (still needed for pigpio)
...
echo "[5/8] Enabling pigpio daemon (still needed for PWM)..."
...
[Unit]
Description=DUSK Smart Vacuum Cleaner (libgpiod)
...
# ----- Verify libgpiod -----
echo ""
echo "  Verifying libgpiod installation..."
gpioinfo 2>/dev/null | head -5 || echo "  gpioinfo not available (will work after reboot)"

# ----- Done -----
echo ""
echo "============================================================"
echo "  Setup Complete! (libgpiod Version)"
echo "============================================================"
echo ""
...
echo ""
echo "  Verify GPIO chip with:"
echo "    gpioinfo /dev/gpiochip0"
echo ""
echo "  To run DUSK:"
echo "    cd $SCRIPT_DIR"
